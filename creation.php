...
function events(){
$events = mysql_query("CREATE TABLE events(UserId int(20),event_text longtext,event_group varchar(25),event_date_creation datetime,event_date_expire datetime,event_tags varchar(255),Exclusiones int(150),EventId NOT NULL AUTO_INCREMENT)")
}
events();
echo "Succes";
?>
